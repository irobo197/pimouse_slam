...
side_scanstartangle = 100
side_scanrange      = 60
front_scanrange     = 100
front_scanstartrange = 334
...
def callback(data):
    global y_l, y_r,x,s_d,front_scanstartrange,front_scanrange,side_scanstartangle,side_scanrange
    ...
    y_r= min(x[length_x-side_scanstartangle-side_scanrange : length_x-side_scanstartangle])  # right wall distance
    s_d= min(x[front_scanstartrange : front_scanstartrange + front_scanrange]) # front wall distance
