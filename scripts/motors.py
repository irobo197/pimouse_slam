...
from geometry_msgs.msg import Twist, Quaternion, TransformStamped, Point # Add modules
from std_srvs.srv import Trigger, TriggerResponse
from raspimouse_ros_2.srv import TimedMotion  # Add
from nav_msgs.msg import Odometry

class Motor():
    def __init__(self):
        if not self.set_power(False): sys.exit(1) # Turn off the motor (True or False)
        ...
        self.srv_tm = rospy.Service('timed_motion', TimedMotion, self.callback_tm)    # Add
        ...
        self.x, self.y, self.th = 0.0, 0.0, 0.0 # Pose
        self.vx, self.vth = 0.0, 0.0 # Linear and Angular velocities
    ...
    def onoff_response(self,onoff): # Add the following 3 methods
        d = TriggerResponse()
